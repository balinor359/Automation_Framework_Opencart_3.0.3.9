...
public class CheckoutSuccessPage extends TestUtilities {
    ...
    public void checkoutSuccessPageValidator() {
        ...
        if (driver.getCurrentUrl().contains(CHECKOUT_SUCCESS_PAGE_URL)) {
            ...
            System.out.println(CHECKOUT_SUCCESS_PAGE_ERROR);
    ...
    public void successHeadingValidator() {
        ...
        Assert.assertEquals(successHeading.getText(), SUCCESS_HEADING_TEXT, GenericMessages.DIFFERENT_TEXT);
    }
    ...
    public void successMessageValidator() {
        ...
        Assert.assertEquals(successMessage.getText(), SUCCESS_MESSAGE_TEXT, GenericMessages.DIFFERENT_TEXT);
    }
    ...
    public void backHomeButtonValidator() {
        ...
        Assert.assertEquals(backHomeButton.getText(), GenericMessages.BACK_HOME_BUTTON_TEXT, GenericMessages.DIFFERENT_TEXT);

        String fontColor = backHomeButton.getCssValue("color");
        String fontColorHex = Color.fromString(fontColor).asHex();
        Assert.assertEquals(fontColorHex, GenericMessages.BACK_HOME_BUTTON_FONT_COLOR, GenericMessages.DIFFERENT_CSS_VALUE);

        String elementBgColor = backHomeButton.getCssValue("background-color");
        String elementBgColorHex = Color.fromString(elementBgColor).asHex();
        Assert.assertEquals(elementBgColorHex, GenericMessages.BACK_HOME_BUTTON_BACKGROUND_COLOR, GenericMessages.DIFFERENT_CSS_VALUE);
    }
